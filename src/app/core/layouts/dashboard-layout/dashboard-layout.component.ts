  ...
  template: `
          ...
          <nav class="sidebar-nav">
            <ul class="nav-list">
              ...
              @if (isSuperAdmin || isOrgAdmin) {
                ...
                <li class="nav-item">
                  <a routerLink="/usage" routerLinkActive="active" class="nav-link">
                    <span class="nav-icon">📈</span>
    ...
    <div class="toast-container">
      @for (toast of toasts; track toast.id) {
        <div class="toast toast-{{ toast.type }} fade-in" [attr.data-id]="toast.id">
  ...
  onOrganizationChange() {
    ...
    this.toastService.show({
      ...
      message: this.selectedOrgId ? 
        `Switched to ${this.organizations.find(o => o.id === this.selectedOrgId)?.name}` : 
