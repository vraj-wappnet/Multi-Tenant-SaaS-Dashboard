...
//     )) {
//       return throwError(() => 'A user with this email already exists in this organization');
//     }

//     // Check user limit for FREE plan organizations
//     if (user.organizationId) {
//       const currentOrgUsers = this.users.filter(u => u.organizationId === user.organizationId);

//       this.organizationService.getOrganization(user.organizationId).subscribe(org => {
//         if (org.plan === 'FREE' && currentOrgUsers.length >= 5) {
//           return throwError(() => 'Free plan is limited to 5 users. Please upgrade your plan.');
//         }
//       });
//     }
...
//     return this.getUsers(organizationId).pipe(
//       map(users => users.length)
//     );
//   }

//   checkUserLimitForOrganization(organizationId: string): Observable<{canAddUser: boolean, reason?: string}> {
...
//             return {
//               canAddUser: false,
//               reason: 'Free plan is limited to 5 users. Please upgrade to add more users.'
//             };
//           }
//         }
