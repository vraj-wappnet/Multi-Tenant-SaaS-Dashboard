...
import { Organization, OrganizationPlan, OrganizationStatus } from '../../../shared/models/organization.model';
            ...
            <div class="card-body">
              ...
              <div class="form-section">
                ...
                <div class="form-control">
                  ...
                  @if (industryInput.invalid && (industryInput.dirty || industryInput.touched)) {
                ...
                <div class="form-control">
                  ...
                  @if (organization.logo) {
                    <div class="logo-preview">
                      <img [src]="organization.logo" alt="Logo preview" width="50" height="50">
                    </div>
                  }
                </div>
              </div>
              ...
              <div class="form-section">
                ...
                <div class="form-control">
                  ...
                  @if (planInput.invalid && (planInput.dirty || planInput.touched)) {
                ...
                <div class="form-control">
                  ...
                  @if (organization.status === 'SUSPENDED') {
                    <div class="alert alert-warning mt-2">
                      <strong>Note:</strong> Suspended organizations will have all users disabled and cannot access the system.
                    </div>
                  }
                </div>
              </div>
...
export class OrganizationFormComponent {
  ...
  onSubmit() {
    ...
    if (this.isEditMode) {
      this.orgService.updateOrganization(this.organizationId, this.organization).subscribe({
        next: () => {
          this.isSaving = false;
      ...
      this.orgService.createOrganization(this.organization as Omit<Organization, 'id' | 'createdAt'>).subscribe({
        next: () => {
          this.isSaving = false;
          this.router.navigate(['/organizations']);
        },
