  ...
  template: `
    <div class="container">
      ...
      @if (loading) {
        ...
        <button class="btn btn-secondary" (click)="goBack()">Back to Users</button>
      } @else {
        <div class="card">
          <form (ngSubmit)="onSubmit()" #userForm="ngForm">
                ...
                <div class="form-control">
                  ...
                  @if (user.status === 'INACTIVE') {
                    <div class="alert alert-warning mt-2">
                      <strong>Note:</strong> Inactive users cannot log in to the system.
                    </div>
                  }
                </div>
              </div>
            ...
            <div class="card-footer">
              ...
              <button 
                ...
                [disabled]="userForm.invalid || isSaving || emailCheckingStatus === 'checking' || emailCheckingStatus === 'error'">
                @if (isSaving) {
...
export class UserFormComponent {
  ...
  checkEmailAvailability() {
    if (!this.user.email || !this.user.organizationId || this.isEditMode) return;
    ...
    this.emailCheckTimeout = setTimeout(() => {
      ...
      const emailExists = this.userService.getUsers(this.user.organizationId!).subscribe(users => {
        const exists = users.some(u => u.email.toLowerCase() === this.user.email!.toLowerCase());
